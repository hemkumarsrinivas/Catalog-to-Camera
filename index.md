...
<figure style="text-align:center;">
    ...
    <figcaption>
        <b>Figure 8.</b> MTF curves at the best focus
</figure>
...
<figure style="text-align:center;">
    ...
    <figcaption>
        <b>Figure 9.</b> Distribution of the on-axis RMS spot radius for the Monte Carlo assemblies.
    </figcaption>
</figure>
...
<figure style="text-align:center;">
    ...
    <figcaption>
        <b>Figure 10.</b> Distribution of the on-axis astigmatism and coma magnitudes.
    </figcaption>
</figure>
...
<figure style="text-align:center;">
    ...
    <figcaption>
        <b>Figure 11.</b> Correlation map between the sampled group misalignments and the resulting aberration metrics.
    </figcaption>
</figure>
...
<figure style="text-align:center;">
    ...
    <figcaption>
        <b>Figure 12.</b> Single-sheet slanted-edge target used for the near-axis MTF measurement.
    </figcaption>
</figure>
...
<figure style="text-align:center;">
    ...
    <figcaption>
        <b>Figure 13.</b> Slanted-edge MTF result obtained with MTF Mapper at an object distance of approximately 3 m.
    </figcaption>
</figure>
...
<figure style="text-align:center;">
    ...
    <figcaption>
        <b>Figure 14.</b> Small flowers with distributed background features, make it easy to spot the swirly Bokeh
    </figcaption>
</figure>
...
<figure style="text-align:center;">
    ...
    <figcaption>
        <b>Figure 15.</b> Another example showing strong subject isolation and a smooth transition into the background
    </figcaption>
</figure>
...
<figure style="text-align:center;">
    ...
    <figcaption>
        <b>Figure 16.</b> An example portrait image, demonstrating useful central sharpness together with a soft, characterful background.
    </figcaption>
</figure>
...
optimization, performance analysis and tolerancing, is provided in the [accompanying notebook](./DIY_Portrait_Lens_Workflow.ipynb).
